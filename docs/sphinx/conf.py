# -*- coding: utf-8 -*-
#
# yabs documentation build configuration file, created by
...
.. |yabs| raw:: html
   ...
   <abbr title="Yet Another Build Script">yabs</abbr>
"""
...
try:
    release = pkg_resources.get_distribution('yabs').version
    ...
    # g_dict = {}
    # exec(open("../../yabs/_version.py").read(), g_dict)
    # # exec(open("../../yabs/__init__.py").read(), g_dict)
...
latex_documents = [
  (master_doc, 'yabs.tex', u'yabs Documentation',
...
man_pages = [
    (master_doc, 'yabs', u'yabs Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'yabs', u'yabs Documentation',
   author, 'yabs', 'One line description of project.',
   'Miscellaneous'),
]
